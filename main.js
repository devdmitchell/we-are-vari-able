...
const myFirstName = "Dessirae"

const myLastName = "Mitchell"

const myFavoriteCeleb = "Chris Brown"

const mySentence = ("My name is " + myFirstName + " " + myLastName + " and my favorite celebrity is " + myFavoriteCeleb)
